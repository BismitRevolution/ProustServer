...
smarty_core_load_plugins(array('plugins' => array(array('function', 'translate', 'layoutEditor/submission/proofread.tpl', 15, false),array('function', 'url', 'layoutEditor/submission/proofread.tpl', 26, false),array('function', 'icon', 'layoutEditor/submission/proofread.tpl', 79, false),array('modifier', 'escape', 'layoutEditor/submission/proofread.tpl', 21, false),array('modifier', 'date_format', 'layoutEditor/submission/proofread.tpl', 40, false),array('modifier', 'default', 'layoutEditor/submission/proofread.tpl', 40, false),array('modifier', 'assign', 'layoutEditor/submission/proofread.tpl', 81, false),)), $this); ?>
...
<table width="100%" class="listing">
	...
	<tr>
		...
		<td>
			<?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['proofreaderProofreadSignoff']->getDateNotified())) ? $this->_run_mod_handler('date_format', true, $_tmp, $this->_tpl_vars['dateFormatShort']) : smarty_modifier_date_format($_tmp, $this->_tpl_vars['dateFormatShort'])))) ? $this->_run_mod_handler('default', true, $_tmp, "&mdash;") : smarty_modifier_default($_tmp, "&mdash;")); ?>
	...
	<tr>
		...
		<td>
			<?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['layoutEditorProofreadSignoff']->getDateNotified())) ? $this->_run_mod_handler('date_format', true, $_tmp, $this->_tpl_vars['dateFormatShort']) : smarty_modifier_date_format($_tmp, $this->_tpl_vars['dateFormatShort'])))) ? $this->_run_mod_handler('default', true, $_tmp, "&mdash;") : smarty_modifier_default($_tmp, "&mdash;")); ?>
		...
		<td>
			<?php if (! $this->_tpl_vars['layoutEditorProofreadSignoff']->getDateNotified() || $this->_tpl_vars['layoutEditorProofreadSignoff']->getDateCompleted()): ?>
			...
			<?php else: ?>
				...
				<?php echo ((is_array($_tmp=$this->_plugins['function']['url'][0][0]->smartyUrl(array('op' => 'layoutEditorProofreadingComplete','articleId' => $this->_tpl_vars['submission']->getId()), $this))) ? $this->_run_mod_handler('assign', true, $_tmp, 'url') : $this->_plugins['modifier']['assign'][0][0]->smartyAssign($_tmp, 'url'));?>
			...
			<?php endif; ?>
			<?php echo ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['layoutEditorProofreadSignoff']->getDateCompleted())) ? $this->_run_mod_handler('date_format', true, $_tmp, $this->_tpl_vars['dateFormatShort']) : smarty_modifier_date_format($_tmp, $this->_tpl_vars['dateFormatShort'])))) ? $this->_run_mod_handler('default', true, $_tmp, "") : smarty_modifier_default($_tmp, "")); ?>
