...
smarty_core_load_plugins(array('plugins' => array(array('modifier', 'escape', 'article/footer.tpl', 23, false),array('modifier', 'to_array', 'article/footer.tpl', 128, false),array('function', 'translate', 'article/footer.tpl', 53, false),array('function', 'call_hook', 'article/footer.tpl', 59, false),array('function', 'url', 'article/footer.tpl', 128, false),array('function', 'get_debug_info', 'article/footer.tpl', 134, false),)), $this); ?>
...
<?php echo ''; ?><?php if ($this->_tpl_vars['currentJournal'] && $this->_tpl_vars['currentJournal']->getSetting('onlineIssn')): ?><?php echo ''; ?><?php $this->assign('issn', $this->_tpl_vars['currentJournal']->getSetting('onlineIssn')); ?><?php echo ''; ?><?php elseif ($this->_tpl_vars['currentJournal'] && $this->_tpl_vars['currentJournal']->getSetting('printIssn')): ?><?php echo ''; ?><?php $this->assign('issn', $this->_tpl_vars['currentJournal']->getSetting('printIssn')); ?><?php echo ''; ?><?php endif; ?><?php echo ''; ?><?php if ($this->_tpl_vars['displayCreativeCommons']): ?><?php echo ''; ?><?php echo $this->_plugins['function']['translate'][0][0]->smartyTranslate(array('key' => "common.ccLicense"), $this);?><?php echo ''; ?><?php endif; ?><?php echo '<div id="pageFooter">'; ?><?php if ($this->_tpl_vars['pageFooter']): ?><?php echo ''; ?><?php echo $this->_tpl_vars['pageFooter']; ?><?php echo ''; ?><?php endif; ?><?php echo ''; ?><?php echo $this->_plugins['function']['call_hook'][0][0]->smartyCallHook(array('name' => "Templates::Common::Footer::PageFooter"), $this);?><?php echo '<div id="standardFooter">'; ?><?php if ($this->_tpl_vars['issn']): ?><?php echo '<p>ISSN: '; ?><?php echo $this->_tpl_vars['issn']; ?><?php echo '</p>'; ?><?php endif; ?><?php echo '<p>Hosted by <a href="http://publishing.gmu.edu">Mason Publishing</a>, part of the <a href="http://library.gmu.edu">George Mason University Libraries</a>.</p></div></div><script type="text/javascript" src="'; ?><?php echo $this->_tpl_vars['baseUrl']; ?><?php echo '/plugins/themes/mpg/js/menu.js"></script><script type=\'text/javascript\' src=\'https://d1bxh8uas1mnw7.cloudfront.net/assets/embed.js\'></script>'; ?>
