...
smarty_core_load_plugins(array('plugins' => array(array('function', 'url', 'controllers/statistics/form/reportGeneratorForm.tpl', 16, false),array('function', 'fbvElement', 'controllers/statistics/form/reportGeneratorForm.tpl', 51, false),array('function', 'html_select_date', 'controllers/statistics/form/reportGeneratorForm.tpl', 80, false),array('function', 'translate', 'controllers/statistics/form/reportGeneratorForm.tpl', 91, false),array('function', 'fbvFormButtons', 'controllers/statistics/form/reportGeneratorForm.tpl', 177, false),array('modifier', 'escape', 'controllers/statistics/form/reportGeneratorForm.tpl', 36, false),array('modifier', 'translate', 'controllers/statistics/form/reportGeneratorForm.tpl', 152, false),array('block', 'fbvFormArea', 'controllers/statistics/form/reportGeneratorForm.tpl', 49, false),array('block', 'fbvFormSection', 'controllers/statistics/form/reportGeneratorForm.tpl', 50, false),)), $this); ?>
...
">
	...
	<?php if ($this->_tpl_vars['reportTemplateOptions']): ?>
		<?php $this->_tag_stack[] = array('fbvFormArea', array('id' => 'reportTemplatesFormArea','title' => "manager.statistics.reports.defaultReportTemplates")); $_block_repeat=true;$this->_plugins['block']['fbvFormArea'][0][0]->smartyFBVFormArea($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
			...
			<?php $_block_content = ob_get_contents(); ob_end_clean(); $_block_repeat=false;echo $this->_plugins['block']['fbvFormSection'][0][0]->smartyFBVFormSection($this->_tag_stack[count($this->_tag_stack)-1][1], $_block_content, $this, $_block_repeat); }  array_pop($this->_tag_stack); ?>
			<?php $this->_tag_stack[] = array('fbvFormSection', array('for' => 'aggregationColumns','title' => "manager.statistics.reports.aggregationColumns",'list' => true)); $_block_repeat=true;$this->_plugins['block']['fbvFormSection'][0][0]->smartyFBVFormSection($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
	...
	<?php if ($this->_tpl_vars['showMonthInputs'] || $this->_tpl_vars['showDayInputs']): ?>
		<?php $this->_tag_stack[] = array('fbvFormArea', array('id' => 'reportTimeFilterArea','title' => "manager.statistics.reports.filters.byTime")); $_block_repeat=true;$this->_plugins['block']['fbvFormArea'][0][0]->smartyFBVFormArea($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>			
			<?php $this->_tag_stack[] = array('fbvFormSection', array('for' => 'currentMonth','size' => $this->_tpl_vars['fbvStyles']['size']['SMALL'],'list' => true)); $_block_repeat=true;$this->_plugins['block']['fbvFormSection'][0][0]->smartyFBVFormSection($this->_tag_stack[count($this->_tag_stack)-1][1], null, $this, $_block_repeat);while ($_block_repeat) { ob_start(); ?>
				<?php echo $this->_plugins['function']['fbvElement'][0][0]->smartyFBVElement(array('type' => 'radio','name' => 'timeFilterOption','value' => @TIME_FILTER_OPTION_CURRENT_DAY,'id' => 'today','checked' => $this->_tpl_vars['today'],'label' => "manager.statistics.reports.today"), $this);?>
