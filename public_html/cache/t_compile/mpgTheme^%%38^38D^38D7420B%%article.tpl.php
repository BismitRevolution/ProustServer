<?php /* Smarty version 2.6.26, created on 2018-04-18 17:18:13
         compiled from article/article.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'translate', 'article/article.tpl', 38, false),array('function', 'call_hook', 'article/article.tpl', 53, false),array('function', 'url', 'article/article.tpl', 87, false),array('modifier', 'escape', 'article/article.tpl', 50, false),array('modifier', 'strip_unsafe_html', 'article/article.tpl', 59, false),array('modifier', 'nl2br', 'article/article.tpl', 65, false),array('modifier', 'to_array', 'article/article.tpl', 87, false),array('block', 'iterate', 'article/article.tpl', 113, false),)), $this); ?>
...
"<?php endif; ?>/>
	...
	<?php if ($this->_tpl_vars['pubId']): ?>
		<div data-badge-popover="bottom" data-badge-type="donut" data-hide-no-mentions="true" data-doi="<?php echo ((is_array($_tmp=$this->_tpl_vars['pubId'])) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
" class="altmetric-embed right" ></div>
	<?php else: ?>
		<div data-badge-popover="bottom" data-badge-type="donut" data-hide-no-mentions="true" data-doi="" class="altmetric-embed right" ></div>
	<?php endif; ?>
	<div id="articleTitle" class="inline-block"><h3><?php echo ((is_array($_tmp=$this->_tpl_vars['article']->getLocalizedTitle())) ? $this->_run_mod_handler('strip_unsafe_html', true, $_tmp) : String::stripUnsafeHtml($_tmp)); ?>
</h3>
...
<div class="block share">
	<a class="twitter-share-button" href="https://twitter.com/share" data-text="<?php echo ((is_array($_tmp=$this->_tpl_vars['article']->getLocalizedTitle())) ? $this->_run_mod_handler('strip_unsafe_html', true, $_tmp) : String::stripUnsafeHtml($_tmp)); ?>
" data-url="<?php echo ((is_array($_tmp=$this->_tpl_vars['pubIdPlugin']->getResolvingURL($this->_tpl_vars['currentJournal']->getId(),$this->_tpl_vars['pubId']))) ? $this->_run_mod_handler('escape', true, $_tmp) : $this->_plugins['modifier']['escape'][0][0]->smartyEscape($_tmp)); ?>
