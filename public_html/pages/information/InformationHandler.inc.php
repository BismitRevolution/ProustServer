	...
	function index($args) {
		...
		switch(isset($args[0])?$args[0]:null) {
			...
			case 'librarians':
				...
				break;
			case 'reviewers':
				$content = $journal->getLocalizedSetting('reviewerInformation');
				$pageTitle = 'navigation.infoForReviewers.long';
				$pageCrumbTitle = 'navigation.infoForReviewers';
				break;
